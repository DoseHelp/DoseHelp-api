...
RSpec.describe "/drugs", type: :request do
  ...
  before(:each) do
    FactoryBot.create(:drug, name: "Methadone", brand_name: "Biodone", form: "liquid", strength: "5mg/ml", cost: 5)
    FactoryBot.create(:drug, name: "Suboxone", brand_name: "Suboxone_film", form: "film", strength: "2mg/0.5mg", cost: 5)
  end

  describe "get all drugs at /drugs" do 
  ...
  describe "get drug at /drugs/:id" do
    it "returns drug based on param" do
      get "/drugs/3"
      expect(response).to have_http_status(200)
      expect(response.body).to include("Methadone")
    end 
