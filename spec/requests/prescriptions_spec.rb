...
RSpec.describe "/prescriptions", type: :request do
  ...
  # before(:each) do 
  #   FactoryBot.create(:prescription, issue_date: "12/02/2021", expiry_date: "12/03/2021", takeaway: true, doctor_id: 1, patient_id: 2, drug_id: 2, prescription_valid: true)
  #   FactoryBot.create(:prescription, issue_date: "28/04/2021", expiry_date: "28/05/2021", takeaway: true, doctor_id: 1, patient_id: 1, drug_id: 1, prescription_valid: true)
  # end

  # describe "get all prescriptions at /prescriptions" do 
  ...
  # describe "get patient at /prescriptions/:id" do 
